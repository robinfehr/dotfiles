...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
	...
	call <SID>X("CursorLineNr", s:lightgray, "", "")
	...
	call <SID>X("Directory", s:lightgray, "", "")
	...
	call <SID>X("javascriptType", s:purple, "", "")
	call <SID>X("javascriptProtoType", s:purple, "", "")
	call <SID>X("javascriptFuncName", s:purple, "", "")
	call <SID>X("javascriptFunctionKey", s:blue, "", "")
	call <SID>X("javascriptThis", s:orange, "", "")
